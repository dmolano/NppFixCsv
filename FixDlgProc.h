...
#define REACHED_SEPARATOR_IN_LENGTH_STATUS REACHED_ENDOFLINE_STATUS + 2

#define REACHED_SEPARATOR_BEFORE_LENGTH_STATUS REACHED_ENDOFLINE_STATUS + 3

#define REACHED_SEPARATOR_AFTER_LENGTH_STATUS REACHED_ENDOFLINE_STATUS + 4
