...
#define REACHED_ENDOFLINE_IN_LENGTH_STATUS SEARCHING_SEPARATOR_STATUS + 1

#define REACHED_ENDOFLINE_BEFORE_LENGTH_STATUS SEARCHING_SEPARATOR_STATUS + 2

#define REACHED_ENDOFLINE_AFTER_LENGTH_STATUS SEARCHING_SEPARATOR_STATUS + 3

#define REACHED_SEPARATOR_IN_LENGTH_STATUS SEARCHING_SEPARATOR_STATUS + 4

#define REACHED_SEPARATOR_BEFORE_LENGTH_STATUS SEARCHING_SEPARATOR_STATUS + 5

#define REACHED_SEPARATOR_AFTER_LENGTH_STATUS SEARCHING_SEPARATOR_STATUS + 6
